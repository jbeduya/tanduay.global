	...
	<div class="article">
		...
		<div class="content">
			...
			<div class="details">
				...
				<div class="author">by <span>{article.author}</span></div>
			</div>
		...
		<div class="links">
			...
			<span class="external"><a href="#"><i class="fas fa-external-link-alt" /></a> </span>
		</div>
	</div>
</section>
...
<style>
	...
	section:hover {
		...
		--title-color: #fff;
		--category-color: #d7d299;
		--content-color: var(--category-color);
	}

	section:hover .links .more {
		color: white;
	}
